...
#include <pcl/registration/hcx.h>
#include "lidar_localization/models/registration/registration_interface.hpp"

namespace lidar_localization {
class HCXRegistration: public RegistrationInterface {
  public:
    HCXRegistration(const YAML::Node& node);
    HCXRegistration(
      float max_corr_dist, 
      float trans_eps, 
  ...
  private:
    pcl::IterativeClosestPoint<CloudData::POINT, CloudData::POINT>::Ptr hcx_ptr_;
};
}
