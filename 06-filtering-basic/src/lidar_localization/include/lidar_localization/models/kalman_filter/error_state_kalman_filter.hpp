...
private:
  ...
  typedef Eigen::Matrix<double, DIM_MEASUREMENT_POSE_VEL, DIM_STATE>
      MatrixGPoseVel;
  typedef Eigen::Matrix<double, DIM_MEASUREMENT_POSE_VEL - 1, DIM_STATE>
      MatrixGPoseVelCons;
  typedef Eigen::Matrix<double, DIM_MEASUREMENT_POSI, DIM_STATE> MatrixGPosi;
  typedef Eigen::Matrix<double, DIM_MEASUREMENT_POSI_VEL, DIM_STATE>
      MatrixGPosiVel;
  typedef Eigen::Matrix<double, DIM_MEASUREMENT_POSI_VEL - 1, DIM_STATE>
      MatrixGPosiVelCons;

  typedef Eigen::Matrix<double, DIM_MEASUREMENT_POSE,
                        DIM_MEASUREMENT_POSE_NOISE>
      MatrixCPose;
  typedef Eigen::Matrix<double, DIM_MEASUREMENT_POSE_VEL,
                        DIM_MEASUREMENT_POSE_VEL_NOISE>
      MatrixCPoseVel;
  typedef Eigen::Matrix<double, DIM_MEASUREMENT_POSE_VEL - 1,
                        DIM_MEASUREMENT_POSE_VEL_NOISE>
      MatrixCPoseVelCons;
  typedef Eigen::Matrix<double, DIM_MEASUREMENT_POSI,
                        DIM_MEASUREMENT_POSI_NOISE>
      MatrixCPosi;
  typedef Eigen::Matrix<double, DIM_MEASUREMENT_POSI_VEL,
                        DIM_MEASUREMENT_POSI_VEL_NOISE>
      MatrixCPosiVel;
  typedef Eigen::Matrix<double, DIM_MEASUREMENT_POSI_VEL - 1,
                        DIM_MEASUREMENT_POSI_VEL_NOISE>
      MatrixCPosiVelCons;

  typedef Eigen::Matrix<double, DIM_MEASUREMENT_POSE_NOISE,
                        DIM_MEASUREMENT_POSE_NOISE>
      MatrixRPose;
  typedef Eigen::Matrix<double, DIM_MEASUREMENT_POSE_VEL_NOISE,
                        DIM_MEASUREMENT_POSE_VEL_NOISE>
      MatrixRPoseVel;
  typedef Eigen::Matrix<double, DIM_MEASUREMENT_POSE_VEL_NOISE - 1,
                        DIM_MEASUREMENT_POSE_VEL_NOISE - 1>
      MatrixRPoseVelCons;
  typedef Eigen::Matrix<double, DIM_MEASUREMENT_POSI_NOISE,
                        DIM_MEASUREMENT_POSI_NOISE>
      MatrixRPosi;
  typedef Eigen::Matrix<double, DIM_MEASUREMENT_POSI_VEL_NOISE,
                        DIM_MEASUREMENT_POSI_VEL_NOISE>
      MatrixRPosiVel;
  typedef Eigen::Matrix<double, DIM_MEASUREMENT_POSI_VEL_NOISE - 1,
                        DIM_MEASUREMENT_POSI_VEL_NOISE - 1>
      MatrixRPosiVelCons;
  ...
  typedef Eigen::Matrix<double, DIM_MEASUREMENT_POSE_VEL - 1, 1>
      VectorYPoseVelCons;
  ...
  typedef Eigen::Matrix<double, DIM_MEASUREMENT_POSI_VEL - 1, 1>
      VectorYPosiVelCons;
  // Kalman gain:
  typedef Eigen::Matrix<double, DIM_STATE, DIM_MEASUREMENT_POSE> MatrixKPose;
  typedef Eigen::Matrix<double, DIM_STATE, DIM_MEASUREMENT_POSE_VEL>
      MatrixKPoseVel;
  typedef Eigen::Matrix<double, DIM_STATE, DIM_MEASUREMENT_POSE_VEL - 1>
      MatrixKPoseVelCons;
  typedef Eigen::Matrix<double, DIM_STATE, DIM_MEASUREMENT_POSI> MatrixKPosi;
  typedef Eigen::Matrix<double, DIM_STATE, DIM_MEASUREMENT_POSI_VEL>
      MatrixKPosiVel;
  typedef Eigen::Matrix<double, DIM_STATE, DIM_MEASUREMENT_POSI_VEL - 1>
      MatrixKPosiVelCons;

  // state observality matrix:
  typedef Eigen::Matrix<double, DIM_STATE * DIM_MEASUREMENT_POSE, DIM_STATE>
      MatrixQPose;
  typedef Eigen::Matrix<double, DIM_STATE * DIM_MEASUREMENT_POSE_VEL, DIM_STATE>
      MatrixQPoseVel;
  typedef Eigen::Matrix<double, DIM_STATE * DIM_MEASUREMENT_POSI, DIM_STATE>
      MatrixQPosi;
  typedef Eigen::Matrix<double, DIM_STATE * DIM_MEASUREMENT_POSI_VEL, DIM_STATE>
      MatrixQPosiVel;
